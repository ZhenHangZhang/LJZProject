...
extension LJZNetworkManager{
    ...
    func searchData(key:String,competopm:@escaping (_ json:AnyObject?) ->()) {
        ...
        let URLStr = "https://b2b.ezparking.com.cn:8080/rtpi-service/parking?type=status&key=4tj2bDvzSDHb&size=-1&fields=cityName,coordinateAmap,districtName,id,speciesName,status,typeName,name&q=\(key)&city=上海市"
        
      _ = URLStr.addingPercentEncoding(withAllowedCharacters: CharacterSet.urlFragmentAllowed)
...
extension LJZNetworkManager{
    ...
    func requestData(parameters:[String:AnyObject],competopm:@escaping (_ json:AnyObject?) ->()) {
        ...
        let URLStr = "https://b2b.ezparking.com.cn/rtpi-service/parking"
